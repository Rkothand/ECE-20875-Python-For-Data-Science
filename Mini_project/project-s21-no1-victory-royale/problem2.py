...
def main():
   # import data
    ...
    # get userIDs who completed at least half of all quizzes
    usercounts = data.groupby("userID").count()
    passed_50_data = data[data["userID"].isin(usercounts.loc[usercounts['s'] > 46, :].index)]
